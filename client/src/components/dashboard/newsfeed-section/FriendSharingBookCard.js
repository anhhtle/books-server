...
export default function FriendSharingBookCard (props) {
    return (
        <div className="newsfeed-card-container">
            <div className="card-heading">
                ...
                <div className="name-date-container">
                    <p className="name"><strong>{props.friend.first_name + ' ' + props.friend.last_name}</strong> is <strong>sharing a book</strong></p>
